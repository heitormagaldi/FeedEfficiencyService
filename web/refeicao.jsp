<%-- 
    Document   : animal.jsp
    Created on : 14/01/2017, 16:56:24
    Author     : Heitor
--%>
...
<html>
    <head>
        ...
        <title>Cadastro de Refei&ccedil;&otilde;es</title>
        ...
        <script type = "text/javascript" src="js/cadastros/refeicao.js"></script>
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Cadastro de Refei&ccedil;&otilde;es  
                            </h1>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                    <i class="fa fa-tag fa"></i> Refei&ccedil;&otilde;es 
                                </li>
                            </ol>
                        </div>
                    </div>
