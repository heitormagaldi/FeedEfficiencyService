...
<html>
    <head>
        ...
        <title>Cadastro de Bebedouro</title>
        ...
        <script type = "text/javascript" src="js/cadastros/bebedouro.js"></script>
    </head>
    <body>
        <div id="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-tag fa"></i> Bebedouro
                                </li>
                            </ol>
                        </div>
                    </div>
