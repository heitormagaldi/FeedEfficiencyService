                ...
                <ul class="nav navbar-right top-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu alert-dropdown">
                            <li>
                                <a href="#">Alerta 1 <span class="label label-default">Alert Badge</span></a>
                            </li>
                            <li>
                                <a href="#">Alerta 2 <span class="label label-primary">Alert Badge</span></a>
                            </li>
                            <li>
                                <a href="#">Alerta 3 <span class="label label-success">Alert Badge</span></a>
                            </li>
                            <li>
                                <a href="#">Alerta 4 <span class="label label-info">Alert Badge</span></a>
                            </li>
                            <li>
                                <a href="#">Alerta 5 <span class="label label-warning">Alert Badge</span></a>
                            </li>
                            <li>
                                <a href="#">Alerta 6 <span class="label label-danger">Alert Badge</span></a>
                            </li>
                            <li class="divider"></li>
                            <li>
                                <a href="#">Ver todos</a>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-fw fa-gear"></i> Configura&ccedil;&atilde;o</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Principal <small> Estat&iacute;sticas Gerais</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li class="active">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> &Aacute;rea Gr&aacute;fica</h3>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Gr&aacute;fico Donut</h3>
                                </div>
                                <div class="panel-body">
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Painel de Transa&ccedil;&otilde;es</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="text-right">
                                        <a href="#">Ver todas transa&ccedil;&otilde;es <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
